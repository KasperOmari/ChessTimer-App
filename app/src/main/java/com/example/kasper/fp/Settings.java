    ...
    public void onClick(View view) {
        if(view.getId() == R.id.done){
            if(btn5.isChecked()) {
                ...
                Intent mn = new Intent(Settings.this,MainActivity.class);
                startActivity(mn);
                ...
                if(!isEmpty(cstMins)) {
                    ...
                    if (time < 1) {
                        MainActivity.ChangeTimers(5);
                        Toast.makeText(Settings.this,"Invalid Time , Default Time Done",Toast.LENGTH_SHORT).show();
                    }
                    else
                    ...
                    Toast.makeText(Settings.this,"Enter Number Of Minutes",Toast.LENGTH_SHORT).show();
                }
            }else {
                Intent mn = new Intent(Settings.this,MainActivity.class);
                startActivity(mn);
